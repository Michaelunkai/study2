    ...
    def __init__(self, text, parent=None):
        ...
        self.setStyleSheet("""
            QPushButton {
                ...
                color: #FFD700;
                font-size: 72px;  /* 3x larger */
                font-weight: bold;
                padding: 20px;
                border: 2px solid #1ABC9C;
                border-radius: 10px;
                min-height: 300px;  /* Increased for larger text */
                min-width: 300px;   /* Increased for larger text */
                text-align: center;
                qproperty-alignment: AlignCenter;
                text-shadow: 0 0 20px #FFD700,  /* Intense glow effect */
                           0 0 30px #FFD700,
                           0 0 40px #FFB000;
            }
            QPushButton:hover {
