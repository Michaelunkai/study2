...
from backend import (
    ...
    parse_date, load_tabs_config, load_session, save_session, run_with_real_time_output
)
...
class DockerApp(QWidget):
    def __init__(self, login_password, is_admin, username):
        ...
        # Lazy load background images and other non-critical components
    ...
    def delayed_init(self):
        ...
        start_docker_engine()
        self.docker_token = perform_docker_login(self.login_password) if self.is_admin else None
        ...
        # Create buttons after everything is initialized
    ...
    def docker_run_command_real_time(self, command):
        ...
        # Use our own implementation instead of relying on backend function
