...
from PyQt5.QtCore import QRunnable, pyqtSignal, QObject, QBuffer, QIODevice, pyqtSlot
...
class ImageWorker(QRunnable):
    ...
    def run(self):
        try:
            if self.is_running and self.button and not self.button.isHidden() and self.button.parent():
