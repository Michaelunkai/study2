...
class LoginDialog(QDialog):
    ...
    def handle_login(self):
        ...
        if not entered:
            ...
            return
        # If the entered password is NOT "123456", assume admin password
        if entered != "123456":
            self.is_admin = True
            self.login_password = entered
            self.accept()
        else:
            # Else, password is 123456. Ask for username.
            ...
            if username.strip().lower() != "meir":
                ...
                return
            self.is_admin = False
            self.login_password = entered  # Not used for non-admin operations.
            self.accept()
