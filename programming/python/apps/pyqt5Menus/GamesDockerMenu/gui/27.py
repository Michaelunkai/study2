...
# ------------------------- Custom Widgets (TagContainerWidget, StyledButton, GameButton, ImageWorker) -------------------------
...
class DockerApp(QWidget):
    ...
    def init_ui(self):
        ...
        """)
        bulk_paste_button.clicked.connect(self.open_bulk_paste_move_dialog)
