# File: youtube_dark_pictures_anthology_playlist.py
import os
import pickle
...
def add_videos_to_playlist_sorted(youtube, playlist_id, keyword):
...
if __name__ == '__main__':
    try:
        ...
        add_videos_to_playlist_sorted(youtube_service, new_playlist_id, "the devil in me")
