...
aws_access_key_id = 'AKIAUELNKO5HAWT2TA6F'
aws_secret_access_key = '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'
region = 'us-east-1'
BUCKET_NAME = 'mywishlist-backup'
DB_FILE = 'wishlist.db'
LOCAL_DB_PATH = 'C:\\study\\programming\\python\\apps\\wishlist\\c\\wishlist.db'
...
def download_db_from_s3():
    s3.download_file(BUCKET_NAME, DB_FILE, LOCAL_DB_PATH)

def upload_db_to_s3():
    s3.upload_file(LOCAL_DB_PATH, BUCKET_NAME, DB_FILE)
...
# Function to create tables if they do not exist (for safety)
def create_tables():
...
# Upload the database to S3 after closing the app
upload_db_to_s3()
