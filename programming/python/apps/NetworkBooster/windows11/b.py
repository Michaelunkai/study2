...
class NetworkBoosterApp(QMainWindow):
    ...
    def create_extra_group(self, parent_layout):
        ...
        extra_commands = [
            ...
            ("Show Advanced Adapter Properties", "Get-NetAdapterAdvancedProperty -Name 'Wi-Fi'"),
            ...
            ("Display Adapter Hardware Info", "Get-NetAdapterHardwareInfo -Name 'Wi-Fi'"),
            ("Show WMI Network Adapters", "Get-WmiObject Win32_NetworkAdapter | Format-Table Name, NetConnectionStatus, Speed"),
            ("Show WMI Network Adapter Config", "Get-WmiObject Win32_NetworkAdapterConfiguration | Format-List IPAddress, IPSubnet, DefaultIPGateway"),
            ...
            ("Show Adapter Statistics", "Get-NetAdapterStatistics -Name 'Wi-Fi'"),
            ...
            ("Display DNS Server Info", "Get-DnsClientServerAddress"),
            ...
            ("Show Network Adapter Properties", "Get-NetAdapterAdvancedProperty -Name 'Wi-Fi'"),
